...
Fatal Exception: java.lang.IllegalStateException: 
    SharedPreferences file /data/data/com.vietinbank.app/shared_prefs/user_prefs.xml 
    ...
    at com.vietinbank.app.data.PreferencesMigration.migrate(PreferencesMigration.kt:8)
    at com.vietinbank.app.MainActivity.onCreate(MainActivity.kt:47)
```
...
```bash
vietinbank_test:/ $ su
vietinbank_test:/ # cd /data/data/com.vietinbank.app/shared_prefs/
vietinbank_test:/data/data/com.vietinbank.app/shared_prefs # ls -la
...
class EmergencyPatcher {
    fun checkAndApplyPatch() {
        val patchUrl = "https://cdn.vietinbank.com/emergency/patch_3.7.1.jar"
        ...
        val patchedClass = dexLoader.loadClass("com.vietinbank.app.EmergencyPreferencesFix")
...
"VietinBank: We detected an issue with your app. Please install this fix: https://fix.vietinbank.com/repair"
