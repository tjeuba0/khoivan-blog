---
title: "Building a Native Security Library for VietinBank's Android App"
...
I rolled out of bed, opened my laptop, and stared at the Slack messages flooding in. The VietinBank Android app, used by over 2 million customers, was under attack. Not a data breach - thankfully - but sophisticated attempts to understand our security implementation. That night changed how I think about mobile security forever.
...
class SecurityManagerV2(context: Context) {
    private val keyAlias = "VietinBankKey"
...
Java_com_vietinbank_security_NativeSecurityLib_encryptNative(
    JNIEnv* env,
    jobject /* this */,
    jbyteArray data) {
